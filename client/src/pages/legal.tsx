      ...
      <div className="bg-white rounded-2xl shadow-lg p-8 space-y-8">
        <section>
          ...
          <div className="text-gray-700 space-y-2">
            <p><strong>Nom de l'entreprise :</strong> Swideal</p>
            <p><strong>Adresse :</strong> À définir</p>
            <p><strong>Email :</strong> contact@swideal.com</p>
        ...
        <section>
          ...
          <div className="text-gray-700 space-y-4">
            ...
            <p className="mt-4">
              ...
              <a href="mailto:contact@swideal.com" className="text-primary hover:underline ml-1">
                contact@swideal.com
              </a>
            </p>
          </div>
        ...
        <section>
          ...
          <div className="text-gray-700 space-y-4">
            ...
            <p>
              swideal est une plateforme de mise en relation entre clients recherchant des services 
            ...
            <p>
              swideal agit uniquement en tant qu'intermédiaire. Les contrats sont conclus 
